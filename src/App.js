        ...
        return (
            <div className="App">
                <div style={{width: "500px", height: "950px", marginLeft: "200px"}}>
                    <Chrono
                        // @ts-ignore
                        items={this.props.data.json} slideShow={true} slideShowDuration={4500} cardHeight={300}
                        mode="VERTICAL_ALTERNATING" theme={{primary: "navy", secondary: "gray".fontsize(72)}}/>
                </div>
            </div>
        );
    }
