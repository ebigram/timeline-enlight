...
var client_id = 'd1ed7c7a877445848b60538606690cf3'; // Your client id
var client_secret = 'f6a10d3cbf7d4379bbbe117499b49d19'; // Your secret
...
spotifyApi.authorizationCodeGrant(code).then(
  function(data) {
   ...
   res.redirect("http://localhost:3000/?token=" + data.body["access_token"])
